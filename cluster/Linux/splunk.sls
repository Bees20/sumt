...
{% set datacenter = salt['pillar.get']('datacenter')|lower%}
...
Mount:
  cmd.run:
    - name: mount -t cifs -o username={{ domainuser }},password={{ passwd }} '\\{{ Domain }}\UDASHARE\{{ datacenter }}-packages\Infra\splunk\linux_x64' /mnt/splunk
