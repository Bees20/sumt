...
/etc/systemd/system/scc_sentinel_exporter.service:
  file.append:
    - text: |
        ...
        [Service]
        User=node_exporter
        EnvironmentFile=/opt/redis_sentinel_exporter/scc_sentinel/config
        ExecStart=/opt/redis_sentinel_exporter/scc_sentinel/redis_sentinel_exporter --web.listen-address=0.0.0.0:9356 $OPTIONS
...
/etc/systemd/system/dcc_sentinel_exporter.service:
  file.append:
    - text: |
        ...
        [Service]
        User=node_exporter
        EnvironmentFile=/opt/redis_sentinel_exporter/dcc_sentinel/config
        ExecStart=/opt/redis_sentinel_exporter/dcc_sentinel/redis_sentinel_exporter $OPTIONS
