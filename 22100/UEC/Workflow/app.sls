...
'{
   ...
   "openbadge": {
      "template": "openbadge.template",
      "directory": "Package/openbadge",
      "servicefile": "/lib/systemd/system/openbadge.service",
      "destination": "/opt/suite/openbadge",
      "configs": {
         "appsettings": {
            "keys": {
               "Update_UDAC_port": {
               ...
               "UpdateLogPath": {
                  ...
                  "_spacing": "          ",
                  "_key": "pathFormat",
                  "_value": "'+ dict['LINUX_LOG_DIRECTORY'] +'openbadge-processor-{Date}.json",
                  "_ending": ","
               },
            ...
            "_name": "appsettings.json",
            "_path": "openbadge/appsettings.json"
         }
      }
   },
