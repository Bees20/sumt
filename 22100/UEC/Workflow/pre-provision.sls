...
download mssql_tools install file:
  file.managed:
    - name: {{base.dsbulk_location}}/{{base.mssql_tools_rpm}}
    - source: {{base.mssql_tools_url}}
    - skip_verify: True

download msodbcsql install file:
  file.managed:
    - name: {{base.dsbulk_location}}/{{base.msodbcsql_rpm}}
    - source: {{base.msodbcsql_url}}
    - skip_verify: True

download python2_pip install file:
  file.managed:
    - name: {{base.dsbulk_location}}/{{base.python2_pip_rpm}}
    - source: {{base.python2_pip_url}}
    - skip_verify: True

download python_setuptools install file:
  file.managed:
    - name: {{base.dsbulk_location}}/{{base.python_setuptools_rpm}}
...
installing python2_pip python_setuptools rpms:
  pkg.installed:
    - sources: 
        - python2-pip: {{base.dsbulk_location}}/{{base.python2_pip_rpm}}
        - python-setuptools: {{base.dsbulk_location}}/{{base.python_setuptools_rpm}}
    - require:
