...
{% import "../../Common/redis/vars.sls" as commonbase %}
...
copy redis conf file:
  file.managed:
    ...
    - source: salt://{{ base.version }}/DCC/Templates/redis.conf
    - template: jinja
...
ensure_copy_service_file:
  file.managed:
    ...
    - source: salt://{{ base.version }}/Common/redis/Templates/{{base.redis_service_file}}
    - template: jinja
    - user: {{ base.redis_user }}
    - group: {{ base.redis_group }}
